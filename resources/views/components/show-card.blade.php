<div class="mt-8">
    <a href="{{route('shows.show', $show['id'])}}">
        <img src="{{'https://image.tmdb.org/t/p/w500/'.$show['poster_path']}}" alt="poster" class="hover:opacity-75 transition ease-in-out duration-150">
    </a>
    <div class="mt-2">
        <a href="{{route('shows.show', $show['id'])}}" class="text-lg mt-2  hover:text-gray:300">{{$show['name']}}</a>
